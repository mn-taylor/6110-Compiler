...
files=$(find ./public-tests/phase1-scanner/public/input/ -type f | grep -v "invalid" -)
...
for f in $files; do
    ...
    diff ./public-tests/phase1-scanner/public/input/${nice_f::-4}.out ./public-tests/phase1-scanner/public/input/${nice_f::-4}.out
    echo 
    done;
